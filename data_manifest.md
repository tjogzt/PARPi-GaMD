...
| results/figures/Fig4B_spearman_data.csv | code/21-spearman_correlation.R | 114 | data/01_curated/trapping_potency.csv + Fig_Mechanism_Data.csv | Fig_Trapping_vs_Allostery.pdf | Results "S1 well depth and AAI show a suggestive inverse relationship"; Fig. fig:trapping | exact permutation test, n = 5 | 2026-09-16 | current | d578bdc6c095964c711bba86cd11ab27 |
...
| data/01_curated/trapping_seed_dataset.csv | scripts/build_seed_dataset.py | 111 | data/01_curated/seed_ligands.csv | ML pipeline; code/26-qsar_analysis.R descriptors | ML seed dataset | RDKit descriptors (version-dependent; incl. n_heavy/n_rings) | 2026-09-16 | current | 886095a83245e33e8aa4128600be1a54 |
