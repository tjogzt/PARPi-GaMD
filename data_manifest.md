...
| results/analysis/trajectory_metadata.csv | scripts/build_trajectory_metadata.py | 1 | DATA_ROOT/*/{*.prmtop,*.dcd,gamd.log} | Methods "Note on replicates"; reviewer Section-8 package | per-system topology hash, frame counts, intervals, log fields | direct file audit | 2026-09-17 | current | TBD |
...
| data/01_curated/trapping_potency.csv | curated input (Murai 2012/2014; Zandarashvili 2020) | — | literature (PMIDs in file) | code/21-spearman_correlation.R | Table 1 trapping column (x olaparib) | western-blot/chromatin trapping, x olaparib | 2026-09-16 | current | 3c1d6afe0269aa75e4d5a8197c368aba |
| data/01_curated/seed_ligands.csv | curated input (PubChem verified) | — | PubChem (CIDs in file) | scripts/build_seed_dataset.py | ML seed source | PubChem canonical SMILES/InChIKey | 2026-09-16 | current | 4fe9fc1c797bab73d7aab97761650986 |
| data/01_curated/trapping_seed_dataset.csv | scripts/build_seed_dataset.py | 111 | data/01_curated/seed_ligands.csv | ML pipeline; code/26-qsar_analysis.R descriptors | ML seed dataset | RDKit descriptors (version-dependent; incl. n_heavy/n_rings) | 2026-09-16 | current | 9cf9e0aed38f59d4b80349a5a6a57964 |
...
| results/figures/Fig_PCA_Features.pdf | code/28-pca_features.R | 40 | pca_projections.csv + pca_eigenvalues.csv | SI Fig. S12 | SI Fig. S12 | 7-point PCA, China palette, Type II/III labels, seed=49 | 2026-09-16 | current | 3230ded9b1de8ad822a17aa9b1138bb5 |
...
| results/figures/Fig_SI_PMF_Convergence.pdf | code/30-convergence_figure.R | 52 | results/tables/pmf_convergence.csv (legacy) | SI Fig. S17 | SI Fig. S17 | thin replicate lines + LOESS + SEM ribbon + 80 ns threshold | 2026-09-16 | current | b1359ddb310c91aaabafbc68a467efe0 |
